...
export declare type SetPublishableKeyOptions = {
    key: string;
};
...
export declare type CreatePiiTokenOptions = {
    pii: string;
} & StripeAccountIdOpt & IdempotencyKeyOpt;
export declare type CreateSourceTokenOptions = {
    type: SourceType;
    params: SourceParams;
};
export declare type FinalizeApplePayTransactionOptions = {
    success: boolean;
};
...
export declare enum GooglePayAuthMethod {
    /**
...
export declare type InitCustomerSessionParams = {
    id: string;
...
export declare enum GooglePayPriceStatus {
    /**
...
export declare enum GooglePayCheckoutOption {
    /**
...
export declare enum GooglePayBillingAddressFormat {
    /**
...
export declare type SourceParams = ThreeDeeSecureParams | GiroPayParams | iDEALParams | SEPADebitParams | SofortParams | AlipayParams | AlipayReusableParams | P24Params | VisaCheckoutParams;
